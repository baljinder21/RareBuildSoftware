...
(function () {
  ...
  const DEFAULT_SOFTWARE = [
    {
      ...
      sha256: '92D0A7D0D6D8E7248ED56EB8C41DCC6A389E232595D06B2066A512F8F344DF88',
      virustotal: 'https://www.virustotal.com/gui/file/92d0a7d0d6d8e7248ed56eb8c41dcc6a389e232595d06b2066a512f8f344df88',
      screenshot: null,
      screenshotPath: '',
      visible: true,
      released: '2025-01-01',
    ...
    },
    {
      ...
      downloadType: 'external',
      sha256: '014E39627F82FDFEB87A2C6A53E2B4F6EC3D6FDC7E48F2D02A5CB60A48F4CB82',
      virustotal: 'https://www.virustotal.com/gui/file/014e39627f82fdfeb87a2c6a53e2b4f6ec3d6fdc7e48f2d02a5cb60a48f4cb82',
      screenshot: null,
      screenshotPath: '',
      visible: true,
      released: '2026-04-12',
    ...
    },
    {
      ...
      downloadType: 'external',
      sha256: 'A67B892F14ADC6251424271B18E341D332D28ED5ED5EE89A0747FE8EF8EC55AB',
      virustotal: 'https://www.virustotal.com/gui/file/a67b892f14adc6251424271b18e341d332d28ed5ed5ee89a0747fe8ef8ec55ab',
      screenshot: null,
      screenshotPath: '',
      visible: true,
      released: '2026-04-14',
    ...
    },
    {
      ...
      downloadType: 'external',
      sha256: 'A81546BEBF0745A27F5E472883E582666EDD06602515A56220D3D116C85F4055',
      virustotal: 'https://www.virustotal.com/gui/file/a81546bebf0745a27f5e472883e582666edd06602515a56220d3d116c85f4055',
      screenshot: null,
      screenshotPath: '',
      visible: true,
      released: '2026-04-19',
  ...
  const DEFAULT_CONTENT = {
    ...
    about: {
      intro:   'RBS started from a simple frustration: too much software that should be free is locked behind subscriptions, trials, and paywalls. I\'m Rai, a solo developer based in Singapore, and I decided to do something about it.',
      body:    'I build practical Windows utilities — optimizers, cleaners, and productivity tools — that are completely free to download and use.',
      mission: 'Building honest, free tools for everyone.'
    },
    contact: {
  ...
  /* Always force icons from DEFAULT_SOFTWARE so stale localStorage can't override them.
     Also fall back to DEFAULT for sha256/virustotal if admin hasn't set them. */
          ...
          <div class="download-sidebar">
            <div class="download-box">
              ...
              <div style="margin-top:14px;padding-top:14px;border-top:1px solid var(--border);font-size:.72rem;color:var(--text-muted);line-height:1.55;word-break:break-all;">
                ${sw.sha256 ? `<div style="margin-bottom:6px;"><span style="color:var(--text-secondary);font-weight:600;">SHA-256:</span><br><code style="color:var(--accent-light);font-size:.66rem;font-family:var(--font-mono,monospace);">${esc(sw.sha256)}</code></div>` : ''}
                ${sw.virustotal ? `<div><span style="color:var(--text-secondary);font-weight:600;">VirusTotal:</span> <a href="${esc(sw.virustotal)}" target="_blank" rel="noopener noreferrer" style="color:var(--accent-light);">View scan →</a></div>` : ''}
              </div>` : ''}
